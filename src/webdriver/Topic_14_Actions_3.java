...
public class Topic_14_Actions_3 {
    WebDriver driver;
    Actions actions;
    JavascriptExecutor jsExecutor;
    String osName = System.getProperty("os.name");

    // đường dẫn đến thư mục code
    ...
    public void TC_01_Drag_And_Drop_HTML4() {
        ...
        WebElement tagetCircle = driver.findElement(By.cssSelector("div#droptarget"));

        actions.dragAndDrop(sourceCircle, tagetCircle).perform();
        Assert.assertEquals(Color.fromString(tagetCircle.getCssValue("background-color")).asHex().toUpperCase(), "#03A9F4");
        Assert.assertEquals(tagetCircle.getText(), "You did great!");
    }

    // cách dùng jQuery ổn định hơn xpath
    @Test
